...
class TrainingVisualizer:
    ...
    def plot_training_curves(
        self, history: dict[str, list[float]], save_path: str | None = None
    ) -> Figure:
        """
...
class DatasetVisualizer:
    ...
    def plot_bbox_size_distribution(
        widths: list[float], heights: list[float], save_path: str | None = None
    ) -> Figure:
        """
    ...
    def plot_image_size_distribution(
        sizes: list[tuple[int, int]], save_path: str | None = None
    ) -> Figure:
        """
...
class ResultsDashboard:
    ...
    def create_dashboard(
        ...
        if (
            "confusion_matrix" in evaluation_results
            and evaluation_results["confusion_matrix"] is not None
        ):
        ...
        fig.suptitle(
            "YOLO 11 Twitter Detection - Training Results Dashboard",
            fontsize=16,
            fontweight="bold",
            y=0.98,
        )
...
def create_comparison_plot(
    results: dict[str, dict[str, float]], metric: str = "mAP50_95", save_path: str | None = None
) -> Figure:
    """
